...
foreach ($objPHPExcel->getWorksheetIterator() as $worksheet)
    ...
    for($row=5; $row<=$highestRow; $row++)
    {
        ...
        $req1="select * from erp_fab_produits where semi = 1 and code='".$code."'";    
        ...
        if(mysql_num_rows($query1)<1){
            ...
            ('".$code."','".$des."','".$code_barre."','".$provenance."','".$prix."','".$seuil."', '1')";
            $requete = mysql_query($sql);
        
    } else {
                echo   $sql="update erp_fab_produits set  code_barre='".$code_barre."', designation='".$des."', provenance='".$provenance."', prix='".$prix."', seuil='".$seuil."' where code='".$code."'";   
               }
            }
        }	
    }
...
?>
                                                ...
                                                <form action="" method="POST" id="form" enctype="multipart/form-data">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" class="form-control input-lg"
                                                            id="FileAImporter" name="FileAImporter" style="height:60px;"
                                                            required>
                                                    </div>
	...
	?>
                                    <tr>
                                        ...
                                        <td><?php echo $type; ?></td>
                                        <td>
                                            <a href="gest_pf.php?ID=<?php echo $id; ?>"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="col-md-12 row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <input id="qte<?php echo $enreg['id']; ?>"
                                                                        name="qte<?php echo $enreg['id']; ?>"
                                                                        class="form-control">
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <br>
                                            ...
                                            <button type="button" class="btn_1 btn-primary waves-effect waves-light"
                                                data-toggle="modal"
                                                            ...
                                                            <div class="col-md-12 row">
                                                                <div class="col-md-5">
                                                                    ...
                                                                    <select class="form-control select2"
                                                                        id="selectMP1<?php echo $enreg['id']; ?>">
                                                                ...
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <input type="button"
                                                                        id="<?php echo $enreg['id']; ?>"
                                                                        value="Enregistrer"
                                                                        class="btn btn-primary btn-sm btnmp_1">
                                                                </div>
                                                            </div>

                                                            <div class="col-md-12 row" style="margin-top:20px"
                                                                id="listeMP1<?php echo $enreg['id']; ?>">
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination">
                                <li class="page-item"><a class="page-link"
                                        href="gest_pf.php?page=<?php echo $Previous; ?>&limit=<?php echo $limit;?>">Précédente</a>
                                </li>
                                <?php 
												for($i=1;$i<=$page;$i++){
											?>
                                <li class="page-item"><a class="page-link"
                                        href="gest_pf.php?page=<?php echo $i; ?>&limit=<?php echo $limit;?>"><?php echo $i; ?></a>
                                </li>
                                <?php } ?>
                                <li class="page-item"><a class="page-link"
                                        href="gest_pf.php?page=<?php echo $Next; ?>&limit=<?php echo $limit;?>">Suivant</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
