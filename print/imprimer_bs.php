...
//$pdf->Image('../assets/pied.png', 0, 276, 210 , 0, 'PNG');
	...
	$r2     = $r1 + 12;
	$pdf->SetXY( $r1, $y1+10);
	$pdf->MultiCell( 140, 4,(utf8_decode("Détail bon de commande sortie")));		
    ...
    $pdf->Ln();$pdf->Ln();
    $des="";
    $pdf->RowHead(array((utf8_decode("Type")),(utf8_decode("Code (Designation)")),(utf8_decode("Designation")),(utf8_decode("Prix unitaire")),(utf8_decode("Quantite")),utf8_decode("Prix total")));
	...
	while($enreg=mysql_fetch_array($query))
	{
        ...
        if($enreg['type']==1){ 
            echo  $pdf ->Row(array(utf8_decode($type) , $sproduit , $enreg["prix_unitaire"], $qte,$qte,$enreg["prix_total"] ));
            }else{ 
                echo  $pdf->Row(array(utf8_decode($type) , $mp , $enreg["prix_unitaire"], $qte,$qte,$enreg["prix_total"] ));
           } 
      
		
	}

$filename="Détail_bon_de_commande_sortie.pdf";
