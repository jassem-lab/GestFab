...
//$pdf->Image('../assets/pied.png', 0, 276, 210 , 0, 'PNG');
	...
	$r2     = $r1 + 12;
	$pdf->SetXY( $r1, $y1+10);
	$pdf->MultiCell( 140, 4,(utf8_decode("List de stock des Produits finis < stock de sécurité ")));		
    ...
    $req="select * from erp_fab_produits where 1=1 and semi = 0 and stock < seuil order by code";
	...
	$type				=	"" ;	
	$i					=	0;
	$req="select * from erp_fab_produits where 1=1 and semi = 0 and stock < seuil";
	$query=mysql_query($req);
	while($enreg=mysql_fetch_array($query))
	{
		$id					=	$enreg["id"] ;	
