...
$pdf->Ln();$pdf->Ln();
$des="";
$pdf->RowHead(array(("Client"),("Produit"),("Couleur"),("Description"),("Quantite"),("Prix")));
	$article="";
	...
	while($enreg=mysql_fetch_array($query))
	{
		...
		$pdf->Row(array(utf8_decode($client),($article),($couleur),($description),($quantite),(number_format($enreg["prix"],'3','.',''))));		
