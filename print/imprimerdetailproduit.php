...
while($enreg=mysql_fetch_array($query))
{
    ...
    $pdf->Ln();$pdf->Ln(); 
    $pdf->RowHead(array((utf8_decode("Produit Semi-finis")),(utf8_decode("Qauntité"))));
    ...
    $pdf->Ln();$pdf->Ln(); 
    $pdf->RowHead(array((utf8_decode("MP du produit SF")),(utf8_decode("Qauntité"))));
    ...
    $pdf->RowHead(array((utf8_decode("Service")),(utf8_decode("Qauntité"))));
