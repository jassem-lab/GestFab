...
//$pdf->Image('../assets/pied.png', 0, 276, 210 , 0, 'PNG');
    ...
    $total_tt=0;
    $total=0;$tot_qte=0;
    $pdf->SetWidths(array(30,20,20,30,30,20,20,20));
    srand(microtime()*1000000);
    $pdf->Ln();$pdf->Ln();
    $des="";
    $pdf->RowHead(array((utf8_decode("Code")),(utf8_decode("Code ( Designation ) ")),(utf8_decode("Code à barre")),(utf8_decode("Provenance")),(utf8_decode("Unité")),(utf8_decode("Prix d'achat")),(utf8_decode("Seuil d’approvisionnement")),(utf8_decode("MP Consommable"))));
	...
	while($enreg=mysql_fetch_array($query))
	{
        ...
        $pdf ->Row(array(utf8_decode($code) , $designation, $code_barre,$provenance,$unite,$prix,$enreg["seuil"],$consommable));
	}
