...
//$pdf->Image('../assets/pied.png', 0, 276, 210 , 0, 'PNG');
	...
	$r2     = $r1 + 12;
	$pdf->SetXY( $r1, $y1+10);
	$pdf->MultiCell( 140, 4,(utf8_decode("Liste des matières premières")));		
    ...
    $pdf->Ln();$pdf->Ln();
    $des="";
    $pdf->RowHead(array((utf8_decode("Code")),(utf8_decode("Designation")),(utf8_decode("Provenance")),(utf8_decode("Unité")),(utf8_decode("Prix d'achat")),(utf8_decode("Stock")),(utf8_decode("Valeur de Stock")),(utf8_decode("Seuil")),(utf8_decode("MP Consommable"))));


    $req="select * from erp_fab_mp where 1=1 order by code";
	...
	$type				=	"" ;	
	$i					=	0;
	$req="select * from erp_fab_mp where 1=1 and stock >= seuil";
	$query=mysql_query($req);
	while($enreg=mysql_fetch_array($query))
	{
		$id					=	$enreg["id"] ;	
		...
		$unite				=	$enreg["unite"] ;
		$i++;
		$valeurStock        =   $enreg["px_achat"] * $enreg["stock"] ; 
		$provenance="";
        ...
        $pdf ->Row(array(utf8_decode($code) , $designation, $provenance,$unite,$prix,$enreg["stock"],$valeurStock,$enreg["seuil"],$consommable));
	}

$filename="Liste_MP_a_commander.pdf";
