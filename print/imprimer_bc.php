...
//$pdf->Image('../assets/pied.png', 0, 276, 210 , 0, 'PNG');
	...
	$r2     = $r1 + 12;
	$pdf->SetXY( $r1, $y1+10);
	$pdf->MultiCell( 140, 4,(utf8_decode("Détail bon de commande client")));		
    ...
    $pdf->Ln();$pdf->Ln();
    $des="";
    $pdf->RowHead(array((utf8_decode("Code - Désingation")),(utf8_decode("Prix unitaire")),(utf8_decode("Quantite")),(utf8_decode("Prix total"))));
	...
	while($enreg=mysql_fetch_array($query))
	{
        ...
        $pdf ->Row(array(utf8_decode($sproduit) , $enreg["prix_unitaire"] , $qte, $enreg["prix_total"] ));
      
		
	}

$filename="Détail_bon_de_commande_client.pdf";
