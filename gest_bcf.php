...
<div class="wrapper">
  ...
  <script>
		function Supprimer(id)
	  {
			...
			{
				document.location.href="page_js/supprimerbcf.php?ID="+id ;
			}			    
	  }	
		function Imprimer(id)
	  {
			if(confirm('Confirmez-vous cette action?'))
			{
				var myMODELE_A4 = window.open("print/imprimer_bcf.php?ID="+id, "_blank", "toolbar=no, scrollbars=yes, resizable=no, top=500, left=500, width=700, height=600");
			}			    
	  }	  	  
  </script>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="card m-b-20">
						<div class="card-body">
						<a href="addedit_bcf.php" class="btn btn-primary waves-effect waves-light">Ajouter un bon de commande fournisseur</a> 
...
<?php
	...
	$req="select * from erp_fab_bcf where 1=1 ".$reqDate.$reqDate1." order by date desc "; 
...
?>
										<tr>
											 ...
											 <?php if($enreg['etat']==0){?>
												<a href="addedit_bcf.php?ID=<?php echo $id; ?>" class="btn btn-warning waves-effect waves-light">
