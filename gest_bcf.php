...
<div class="wrapper">
    ...
    function Imprimer(id) {
        if (confirm('Confirmez-vous cette action?')) {
            var myMODELE_A4 = window.open("print/imprimer_bcf.php?ID=" + id, "_blank",
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            <a href="addedit_bcf.php" class="btn btn-primary waves-effect waves-light">Ajouter un bon de
						...
						?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if($enreg['etat']==0){?>
                                            <a href="addedit_bcf.php?ID=<?php echo $id; ?>"
