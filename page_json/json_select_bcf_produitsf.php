...
?>
	...
	<select class="form-control select2" name="produit" id="produit">
		...
		<?php
		$req0="select * from erp_fab_produits  where semi=0 and provenance=2 and not exists(select * from erp_bc_det_bcf where erp_bc_det_bcf.produit=erp_fab_produits.id and erp_bc_det_bcf.idbc=".$id.")";
