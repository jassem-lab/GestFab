...
<div class="wrapper">
    ...
    function Imprimer(id) {
        if (confirm('Confirmez-vous cette action?')) {
            var myMODELE_A4 = window.open("print/imprimer_bc.php?ID=" + id, "_blank",
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            <a href="addedit_bc.php" class="btn btn-primary waves-effect waves-light">Ajouter un bon de
                                commande client</a>
...
?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="cbn_bc.php?ID=<?php echo $id; ?>"
                                                class="btn btn-warning waves-effect waves-light"
