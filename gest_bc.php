...
<div class="wrapper">
  ...
  <script>
		function Supprimer(id)
	  {
			...
			{
				document.location.href="page_js/supprimerbc.php?ID="+id ;
			}			    
	  }	
		function Imprimer(id)
	  {
			if(confirm('Confirmez-vous cette action?'))
			{
				var myMODELE_A4 = window.open("print/imprimer_bc.php?ID="+id, "_blank", "toolbar=no, scrollbars=yes, resizable=no, top=500, left=500, width=700, height=600");
			}			    
	  }	  	  
  </script>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="card m-b-20">
						<div class="card-body">
						<a href="addedit_bc.php" class="btn btn-primary waves-effect waves-light">Ajouter un bon de commande client</a> 
...
<?php
	...
	$req="select * from erp_fab_bc where 1=1 ".$reqDate.$reqDate1." order by date desc "; 
...
?>
										<tr>
											 ...
											 <?php if($enreg['etat']==0){?>
												<a href="addedit_bc.php?ID=<?php echo $id; ?>" class="btn btn-warning waves-effect waves-light">
												...
												<a href="cbn_bc.php?ID=<?php echo $id; ?>" class="btn btn-warning waves-effect waves-light"  style="background-color:green">
													C.B.N
												</a>		
											 <?php } else{ ?>
													<b style="color:green">Commande générer vers Ordre de fabrication</b>
											 <?php } ?>
											 </td>
										</tr>
	<?php } ?>
