						...
						<div class="card-body">
							...
							<form action="" method="POST">    
								<div class="form-group row">
									...
									<div class="col-sm-2">
									<b>Unité</b>
										<input class="form-control"  type="text"  placeholder="Unité" value="<?php echo $unite; ?>" id="example-text-input" name="unite" >
									</div>										
									<div class="col-sm-3">
									<b>Px d'achat par défaut</b>
										<input class="form-control"  type="number"  placeholder="Prix d'achat" value="<?php echo $px_achat; ?>" id="example-text-input" name="px_achat" >
									</div>										
									<div class="col-sm-3" style="">
									<b>Provenance </b>
										<select name="type" name="provenance" id="provenance" class="form-control" required>
											...
											?>
												<option value="<?php echo $enreg['id']; ?>" <?php if($enreg['id']==$provenance){ ?> selected <?php } ?>>
									...
									<div class="col-sm-2">
										...
										<b>MP Consommable</b>
										<br>
										<input name="group2" type="radio" id="radio_4" class="radio-col-grey" value="1" <?php if ($consommable=="1") { ?> checked <?php }?>/>
										<label for="radio_4">Oui</label>
										<input name="group2" type="radio" id="radio_5" value="0" class="radio-col-blue"   <?php if ($consommable=="0") { ?> checked <?php }?>/>
											...
											<div class="col-xl-2">
												<form name="SubmitContact" class="" method="post" action="">
																...
																<select class="form-control select2" name="limit-records" id="limit-records">
																	<option value="20" <?php if (isset($_POST['limit-records'])){ if($_POST['limit-records']==20){ ?> selected <?php }} ?>>20 MPs</option>	
																	<option value="50" <?php if (isset($_POST['limit-records'])){ if($_POST['limit-records']==50){ ?> selected <?php }} ?>>50 MPs</option>	
																	<option value="10" <?php if (isset($_POST['limit-records'])){ if($_POST['limit-records']==100){ ?> selected <?php }} ?>>100 MPs</option>
																</select>	
												</form>	
											</div>											
											<div class="col-xl-3">
...
<?php
	...
	?>
										<tr>
											 ...
											 <td>
												<a href="mps.php?ID=<?php echo $id; ?>" class="btn btn-warning waves-effect waves-light">Modifier</a>
	...
	<?php } ?>
									...
									<nav aria-label="Page navigation example">
                                        <ul class="pagination">
                                            <li class="page-item"><a class="page-link" href="mps.php?page=<?php echo $Previous; ?>&limit=<?php echo $limit;?>">Précédente</a></li>
											<?php 
												for($i=1;$i<=$page;$i++){
											?>
                                            <li class="page-item"><a class="page-link" href="mps.php?page=<?php echo $i; ?>&limit=<?php echo $limit;?>"><?php echo $i; ?></a></li>
												<?php } ?>
                                            <li class="page-item"><a class="page-link" href="mps.php?page=<?php echo $Next; ?>&limit=<?php echo $limit;?>">Suivant</a></li>
                                        </ul>
                                    </nav>							
					</div> 
