...
$objPHPExcel->getActiveSheet()->getColumnDimension('G')->setAutoSize(true);
	...
	$article="";
	$req="select * from erp_fab_produits  order by code desc ";
...
$objPHPExcel->getActiveSheet()->setTitle('Inventaire SF');


header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment;filename="inventaire_sf.xls"');
