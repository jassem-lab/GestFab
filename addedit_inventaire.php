			...
			<div class="row">
				<div class="col-lg-12">
					<div class="card m-b-20">
						...
						<a href="modele_sf.php" class="btn btn-primary waves-effect waves-light" style="background-color: orange">Modèle Produit finis et semis-finis </a> 
						<a href="modele_mp.php" class="btn btn-primary waves-effect waves-light" style="background-color: pink">Matières premières </a> 						
								...
								<form action="" method="POST"  enctype="multipart/form-data">  
									<div class="form-group row">
										<div class="col-sm-2">
											...
											id="example-text-input" name="reference" required readonly>
										</div>
										<div class="col-sm-3">
											<b>Type (*)</b>
											<select class="form-control select2" id="type" name="type" required>
												<option value=""> Sélectionner le type d'inventaire </option>
												<option value="1" <?php if($type=="1"){ ?> selected <?php } ?>>Produit semis-finis</option>
