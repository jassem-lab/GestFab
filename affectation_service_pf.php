...
<div class="wrapper">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-2">
											...
											?>
                                                <option value="<?php echo $enreg['id']; ?>"
                                                    <?php if($service==$enreg['id']){ ?> selected <?php } ?>>
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <input class="form-control" type="number"
                                                placeholder="Temps d'éxection (Comp)"
                                                value="<?php echo $temps_execution; ?>" id="example-text-input"
                                                name="temps_execution" required>
                                        </div>
                                        <div class="col-sm-2">
                                            <b>Couleur (Color)</b>
											...
											?>
                                                <option value="<?php echo $enreg['id']; ?>"
                                                    <?php if($couleur==$enreg['id']){ ?> selected <?php } ?>>
                                        ...
                                        <div class="col-sm-2">
											...
											?>
                                                <option value="<?php echo $enreg['id']; ?>"
                                                    <?php if($cliche==$enreg['id']){ ?> selected <?php } ?>>
                                        ...
                                        <div class="col-sm-2">
                                            <b>Box Qty (*)</b>
                                            <input class="form-control" type="number" placeholder="Box Qty"
                                                value="<?php echo $box_qty; ?>" id="example-text-input" name="box_qty">
                                        </div>
                                        <div class="col-sm-2">
                                            <b>Jig (Gigue)</b>
											...
											?>
                                                <option value="<?php echo $enreg['id']; ?>"
                                                    <?php if($jig==$enreg['id']){ ?> selected <?php } ?>>
                                                    <?php echo $enreg['jig']; ?>
                                                </option>
                                                <?php } ?>
                                            </select>
                                        ...
                                        <div class="col-sm-2">
											...
											?>
                                                <option value="<?php echo $enreg['id']; ?>"
                                                    <?php if($moule==$enreg['id']){ ?> selected <?php } ?>>
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <input class="form-control" type="number" step="0.1"
                                                placeholder="Net Weight" value="<?php echo $poids_net; ?>"
                                                id="poids_net" name="poids_net" required>
                                            <input type="hidden" id="pourcentage_brute" name="pourcentage_brute"
                                                value="<?php echo $pourcentage_brute; ?>">
                                        </div>
                                        <div class="col-sm-2">
                                            <b>Poids brute(Gross Weight) (*)</b>
                                            <input class="form-control" type="number" step="0.1"
                                                placeholder="Gross Weight" value="<?php echo $poids_brute; ?>"
                                                id="poids_brute" name="poids_brute" readonly>
                                        </div>
                                        <div class="col-sm-2">
                                            <b>Cavity (Cavité) (*)</b>
                                            <input class="form-control" type="number" placeholder="cavity"
                                                value="<?php echo $cavity; ?>" id="cavity" name="cavity" required>
                                        </div>
	...
	?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="affectation_service.php?IDP=<?php echo $_GET['IDP']; ?>&ID=<?php echo $enreg['id'];?>"
                                                class="btn btn-warning waves-effect waves-light">Modifier</a>
                                            <a href="Javascript:Supprimer('<?php echo $_GET['IDP']; ?>','<?php echo $enreg['id'];?>')"
                                                class="btn btn-danger waves-effect waves-light"
                                                style="background-color:red">Supprimer</a>
                                            <button type="button" class="btn btn-primary waves-effect waves-light"
                                                data-toggle="modal"
                                                data-target=".bs-example-modal-lg<?php echo $enreg['idservice']; ?>"
                                                id="<?php echo $enreg['idservice']; ?>">
                                                Nomenclature (<?php echo $nomenclature; ?>)
                                            </button>
                                            <!--  Modal content for the above example -->
                                            <div class="modal fade bs-example-modal-lg<?php echo $enreg['idservice']; ?>"
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="col-md-12 row">
                                                                <div class="col-md-5"
                                                                    id="selectMP<?php echo $enreg['idservice']; ?>">

                                                                </div>
                                                                <div class="col-md-3">
                                                                    <b>Quantité (par unité)</b>
                                                                    <input id="qte<?php echo $enreg['idservice']; ?>"
                                                                        name="qte<?php echo $enreg['idservice']; ?>"
                                                                        class="form-control">
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <br>
                                                            ...
                                                            <div class="col-md-12 row" style="margin-top:20px"
                                                                id="listeMP<?php echo $enreg['idservice']; ?>">
