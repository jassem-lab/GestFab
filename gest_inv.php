...
<div class="wrapper">
  ...
  <script>
		...
		function Imprimer(id)
	  {
			if(confirm('Confirmez-vous cette action?'))
			{
				var myMODELE_A4 = window.open("print/imprimer_inventaire.php?ID="+id, "_blank", "toolbar=no, scrollbars=yes, resizable=no, top=500, left=500, width=700, height=600");
			}			    
	  }	  	  
  </script>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="card m-b-20">
						<div class="card-body">
						<a href="addedit_inventaire.php" class="btn btn-primary waves-effect waves-light">Ajouter un inventaire de stock</a> 
...
?>
										<tr>
											...
											<?php if($enreg['etat']==0){ ?>
												...
												<a href="Javascript:MAJ('<?php echo $id; ?>')" class="btn btn-danger waves-effect waves-light" style="background-color:green">
