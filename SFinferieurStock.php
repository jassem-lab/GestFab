...
function Imprimer() {
    if (confirm('Confirmez-vous cette action?')) {
        var myMODELE_A4 = window.open("print/imprimerSFsecurite.php",
...
<div class="wrapper">
    ...
    <div class="page-title-box">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="page-title">Stock produit Semi finis inférieur au stock de sécurité </h4>
...
?> <div class="page-content-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            <h3>Stock produit Semi finis inférieur au stock de sécurité </h3>
    ...
    WHERE stock < seuil
    AND semi = 1 ".$reqCode." order by code";
	$query=mysql_query($req);
	...
	$req="SELECT *
            FROM `erp_fab_produits`
            WHERE stock < seuil
            AND semi = 1".$reqCode." order by code  LIMIT $start, $limit";
	$query=mysql_query($req);
	while($enreg=mysql_fetch_array($query))
	{
		$id					=	$enreg["id"] ;	
