...
<div class="wrapper">
    ...
    <div class="page-title-box">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="page-title">Provenance des provenances </h4>
...
if(isset($_POST['enregistrer_mail'])){	
	...
	if($id=="0")
		{
			$sql="INSERT INTO `erp_fab_classe`(`classe`) VALUES
			('".$classe."' )";
			...
			$sql="UPDATE `erp_fab_classe` SET `classe`='".$classe."' WHERE id=".$id;
	...
	$req="select * from erp_fab_classe where id=".$id;
...
?>
	...
	$id		=	"0" ;		
	$i		=	"0" ;
	$req="select * from erp_fab_classe where 1=1 ".$reqClasse." order by classe ";
	$query=mysql_query($req);
	while($enreg=mysql_fetch_array($query))
	{
		$nom	=	$enreg["classe"] ;
