...
--
-- Client: localhost
-- Généré le: Mar 26 Avril 2022 à 13:23
...
INSERT INTO `erp_bc` (`id`, `reference`, `client`, `trimestre`, `annee`, `date`, `dateheure`, `idutilisateur`, `montant`, `etat`, `remarque`, `type`) VALUES
(1, 'BC_2022_001', 1, 1, '2022', '2022-04-26', '2022-04-26 09:48:15', 1, '428', 0, '', 0),
(2, 'BC_2022_002', 1, 2, '2022', '2022-04-26', '2022-04-26 10:14:35', 1, '274', 0, '', 0);
...
INSERT INTO `erp_det_bc` (`id`, `idbc`, `produit`, `quantite`, `prix_unitaire`, `prix_total`, `poids`, `volume`) VALUES
(1, 1, 21, 5, '35', '175', '50', '80'),
(6, 1, 26, 6, '27.5', '165', '30', '50'),
(8, 1, 24, 4, '22', '88', '', ''),
(9, 2, 27, 5, '33.8', '169', '', ''),
(10, 2, 21, 3, '35', '105', '50', '80'),
(11, 2, 24, 1, '22', '0', '', '');
