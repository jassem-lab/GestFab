                            ...
                            <ul class="submenu megamenu">
                                <li>
                                    <ul>
                                        ...
                                        <li><a href="val_stock_mp.php"><b style="font-size:12px">Valorisation de stock
                                                    MP</a></b></li>
                                        ...
                                        <li><a href="SFinferieurStock.php"><b style="font-size:12px">SF < Stock
                                                        sécurité</a></b>
                                        </li>
                                        <li><a href="FinferieurStock.php"><b style="font-size:12px">PF < Stock
                                                        sécurité</a></b>
                                        </li>
                                    </ul>
                                </li>
